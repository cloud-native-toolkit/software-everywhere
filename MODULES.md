...
| *Cloud Pak Platform Navigator* | ibm-cp-platform-navigator | https://github.com/ibm-garage-cloud/terraform-ibm-cp-platform-navigator | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-ibm-cp-platform-navigator?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-ibm-cp-platform-navigator/workflows/Verify%20and%20release%20module/badge.svg) |
...
| **Module name** | **Module id** | **Module location** | **Latest release** | **Last build status** |
|-----------------|---------------|---------------------|--------------------|-----------------------|
| *IBM AppId* | ibm-appid | https://github.com/ibm-garage-cloud/terraform-ibm-appid | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-ibm-appid?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-ibm-appid/workflows/Verify%20and%20release%20module/badge.svg) |
...
| *App Connect* | cp-app-connect | https://github.com/ibm-garage-cloud/terraform-ibm-cp-app-connect | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-ibm-cp-app-connect?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-ibm-cp-app-connect/workflows/Verify%20and%20release%20module/badge.svg) |

### Dev Tools

| **Module name** | **Module id** | **Module location** | **Latest release** | **Last build status** |
|-----------------|---------------|---------------------|--------------------|-----------------------|
| *ArgoCD* | argocd | https://github.com/ibm-garage-cloud/terraform-tools-argocd | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-tools-argocd?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-tools-argocd/workflows/Verify%20and%20release%20module/badge.svg) |
| *Artifactory* | artifactory | https://github.com/ibm-garage-cloud/terraform-tools-artifactory | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-tools-artifactory?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-tools-artifactory/workflows/Verify%20and%20release%20module/badge.svg) |
| *Developer Dashboard* | dashboard | https://github.com/ibm-garage-cloud/terraform-tools-dashboard | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-tools-dashboard?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-tools-dashboard/workflows/Verify%20and%20release%20module/badge.svg) |
| *Jenkins* | jenkins | https://github.com/ibm-garage-cloud/terraform-tools-jenkins | ![Latest release](https://img.shields.io/github/v/release/ibm-garage-cloud/terraform-tools-jenkins?sort=semver) | ![Verify and release module](https://github.com/ibm-garage-cloud/terraform-tools-jenkins/workflows/Verify%20and%20release%20module/badge.svg) |
